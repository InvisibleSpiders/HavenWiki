...
| --- | --- |
| `/haven help` | Shows HavenNecessities help. |
| `/spawn` | Teleports you to server spawn. |
| `/sethome [name]` | Saves a home location. |
| `/home [name]` | Teleports to one of your homes. |
| `/warps` | Lists server warps. |
| `/rtp` | Randomly teleports to a safe location. |
...
| `/cosmetics` | Opens the cosmetics hub when enabled. |
| `/afk` | Toggles AFK status. |

## Main Ideas

- Wallet money is used by payments, banks, some upgrades, and optional teleport costs.
