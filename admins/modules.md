...
| `modules/chat.yml` | Chat formatting, tab header/footer, tab player names, and PvP marker. |
| `modules/custommessage.yml` | Prefixes, join messages, leave messages, purchases, and custom text. |
